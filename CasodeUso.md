...
|------------------------|--------------------------------------------------------------------------------------|
| Volumen de datos       | 2M transacciones/día · Picos de 8.000 TPS                                           |
| Latencia requerida     | < 200ms por transacción (p99)                                                       |
| Disponibilidad         | 99.99% (máximo 52 minutos de downtime/año)                                          |
| Retención de datos     | Transacciones: 5 años · Features ML: 90 días                                        |
| Throughput streaming   | ~100 MB/s en horas pico                                                             |
| Reentrenamiento        | Modelo actualizado cada hora con datos del día                                       |
| Volumen histórico      | ~3 TB de transacciones históricas etiquetadas                                       |
| Regulación             | Cumplimiento Habeas Data, SARLAFT, reporte a Superfinanciera                        |
```
